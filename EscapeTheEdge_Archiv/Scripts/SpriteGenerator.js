...
(function (EscapeTheEdge_Archiv) {
    ...
    EscapeTheEdge_Archiv.SpriteFrame = SpriteFrame;
    class Sprite {
        constructor(_name) {
            this.frames = [];
            this.name = _name;
    ...
    EscapeTheEdge_Archiv.Sprite = Sprite;
    ...
    EscapeTheEdge_Archiv.NodeSprite = NodeSprite;
})(EscapeTheEdge_Archiv || (EscapeTheEdge_Archiv = {}));
